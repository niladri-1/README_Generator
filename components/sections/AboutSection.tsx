  ...
  return (
    <div className="space-y-6">
      <div className="space-y-4">
        <div>
          <Label htmlFor="currentWork" className="text-white">Currently working on</Label>
          <Input
            id="currentWork"
        ...
        <div>
          <Label htmlFor="collaboration" className="text-white">Looking to collaborate on</Label>
          <Input
            id="collaboration"
        ...
        <div>
          <Label htmlFor="learning" className="text-white">Currently learning</Label>
          <Input
            id="learning"
        ...
        <div>
          <Label htmlFor="askAbout" className="text-white">Ask me about</Label>
          <Input
            id="askAbout"
