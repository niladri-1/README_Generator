    ...
    <div className="space-y-6">
      <Card className="bg-gray-700/50 border-gray-600">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <Label htmlFor="projectTech" className="text-white">Technologies (comma-separated)</Label>
              <Input
                id="projectTech"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <Label htmlFor="projectGithub" className="text-white">GitHub URL</Label>
              <Input
                id="projectGithub"
            ...
            <div>
              <Label htmlFor="projectDemo" className="text-white">Live Demo URL</Label>
              <Input
                id="projectDemo"
      ...
      {readmeData.projects.length > 0 && (
        <div className="space-y-4">
          <Label className="text-white text-lg">Your Projects</Label>
